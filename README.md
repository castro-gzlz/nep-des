...
In the left panel ([example#1](aux/config_examples.ipynb)), we contextualize several unusual planets located within the core of the Neptunian desert. In the right panel ([example#2](aux/config_examples.ipynb)), we place a sub-Saturn within the broader exo-Neptunian landscape (desert, ridge, and savanna) and highlight it with a text box.
