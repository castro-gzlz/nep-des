...
<p>
  ...
  population-based <strong>boundaries</strong> of the <strong>Neptunian desert</strong>, 
  ...
  Castro-González et al. (2024)</a>. It also generates two-column plots with the <strong>density trend</strong> for 
