...
<p>
  ...
  This code generates <strong>period–radius diagrams</strong> with the <strong>population-based</strong> boundaries</strong> of the <strong>Neptunian desert</strong>, 
  ...
  Castro-González et al. (2024)</a>. It also generates two-column plots with the <strong>density-period trend</strong> for 
