...
This plotting option also uses an MCMC approach to assess the significance of the trend. At present, and without including the (duplicated) user-plotted planets in the statistics (`include_user_planets_in_density_stats = False`):
