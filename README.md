...
<p>
  ...
  This code produces <strong>period–radius figures</strong> with the <strong>population-based</strong> boundaries</strong> of the <strong>Neptunian desert</strong>, 
