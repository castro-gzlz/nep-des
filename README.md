...
<p>No installation is required. Simply <strong>clone</strong> or <strong>download</strong> this repository and run <a href="https://github.com/castro-gzlz/nep-des/blob/main/nep_des.ipynb"><code>nep_des.ipynb</code></a>. You just need to adapt the <a href="nep_des.ipynb#user-configuration">User configuration</a> section, run the (collapsed) cells of <strong>Main code block</strong>, and then run any of the <strong>three plotting cells</strong>. In the following, we show five examples of operation covering the three possible diagrams generated by nep-des. The configuration cells of each example can be found in this folder.</p>
