...
<p>
  ...
  This code produces <strong>period–radius diagrams</strong> with the <strong>population-based</strong> boundaries</strong> of the <strong>exo-Neptunian landscape</strong> (Neptunian <strong>desert</strong>, 
  <strong>ridge</strong>, <strong>and savanna</strong>) derived in 
