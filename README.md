...
We can also generate the **exact KDE-derived desert boundaries**. These boundaries are more precise, making them more appropriate for direct comparison with theoretical models.
